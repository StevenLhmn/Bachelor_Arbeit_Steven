...
\firstSupervisor{Prof. Dr. Jan Sudeikat}
\secondSupervisor{xxx}

% text field
%-> replace title with your thesis title
\thesisTitle{Vergleich von Algorithmen zur Gruppierung von Prosumern für die Bildung urbaner Energiecommunities}
\thesisTitleEN{xxx}
...
\thesisAuthor{Steven Niclas Lehmann}
